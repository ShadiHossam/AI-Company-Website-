...
// /sitemap.xml is the canonical sitemap URL: robots.txt, the layouts'
// <link rel="sitemap">, llms.txt and every Search Console / Bing submission
// point here. /sitemap_index.xml only 301s back to it for old submissions.
