...
const PAGES: PageEntry[] = [
  ...
  { url: '/services/ai-courses',                            lastmod: NOW, priority: '0.7', changefreq: 'weekly' },
  { url: '/services/ai-courses/dubai',                      lastmod: NOW, priority: '0.6', changefreq: 'monthly' },
  { url: '/services/ai-courses/abu-dhabi',                  lastmod: NOW, priority: '0.6', changefreq: 'monthly' },
  { url: '/services/ai-courses/generative-ai',              lastmod: NOW, priority: '0.6', changefreq: 'monthly' },
  { url: '/services/ai-courses/agentic-ai',                 lastmod: NOW, priority: '0.6', changefreq: 'monthly' },
  { url: '/services/ai-courses/prompt-engineering',         lastmod: NOW, priority: '0.6', changefreq: 'monthly' },
  { url: '/services/ai-courses/managers',                   lastmod: NOW, priority: '0.6', changefreq: 'monthly' },
  { url: '/services/ai-courses/hr',                         lastmod: NOW, priority: '0.6', changefreq: 'monthly' },
  { url: '/services/ai-courses/finance',                    lastmod: NOW, priority: '0.6', changefreq: 'monthly' },
  { url: '/services/ai-courses/marketing',                  lastmod: NOW, priority: '0.6', changefreq: 'monthly' },
  { url: '/services/ai-courses/sales',                      lastmod: NOW, priority: '0.6', changefreq: 'monthly' },
  { url: '/services/ai-courses/real-estate',                lastmod: NOW, priority: '0.6', changefreq: 'monthly' },
  { url: '/services/ai-courses/beginners',                  lastmod: NOW, priority: '0.6', changefreq: 'monthly' },
  { url: '/services/ai-courses/free-ai-courses-uae',        lastmod: NOW, priority: '0.5', changefreq: 'monthly' },
  { url: '/services/ai-courses/automation',                 lastmod: NOW, priority: '0.6', changefreq: 'monthly' },
  { url: '/services/ai-courses/ai-agents',                  lastmod: NOW, priority: '0.6', changefreq: 'monthly' },
